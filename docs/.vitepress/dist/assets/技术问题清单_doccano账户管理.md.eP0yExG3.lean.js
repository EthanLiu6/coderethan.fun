import{_ as a,c as i,a2 as n,o as e}from"./chunks/framework.C9NVOr0y.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"技术问题清单/doccano账户管理.md","filePath":"技术问题清单/doccano账户管理.md","lastUpdated":null}'),p={name:"技术问题清单/doccano账户管理.md"};function l(t,s,h,c,k,o){return e(),i("div",null,s[0]||(s[0]=[n(`<h2 id="docker下的doccano添加普通用户" tabindex="-1">Docker下的doccano添加普通用户 <a class="header-anchor" href="#docker下的doccano添加普通用户" aria-label="Permalink to &quot;Docker下的doccano添加普通用户&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">整体实现方式</p><p>240910-问题</p><p>通过不断排查发现，24年最新版本的有一些bug，无法创建普通用户，只能创建超管然后将别的超管作为员工添加到项目中。</p></div><h3 id="_1-操作步骤" tabindex="-1">1. 操作步骤 <a class="header-anchor" href="#_1-操作步骤" aria-label="Permalink to &quot;1. 操作步骤&quot;">​</a></h3><h3 id="_1-1-启动docker的doccano" tabindex="-1">1.1 启动docker的doccano <a class="header-anchor" href="#_1-1-启动docker的doccano" aria-label="Permalink to &quot;1.1 启动docker的doccano&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 需要提前创建好doccano服务才行（docker run …………）</span></span>
