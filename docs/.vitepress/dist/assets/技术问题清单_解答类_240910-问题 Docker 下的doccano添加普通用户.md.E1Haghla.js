import{_ as a,c as n,a2 as i,o as e}from"./chunks/framework.C9NVOr0y.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"技术问题清单/解答类/240910-问题 Docker 下的doccano添加普通用户.md","filePath":"技术问题清单/解答类/240910-问题 Docker 下的doccano添加普通用户.md","lastUpdated":1728624890000}'),p={name:"技术问题清单/解答类/240910-问题 Docker 下的doccano添加普通用户.md"};function l(t,s,c,h,o,k){return e(),n("div",null,s[0]||(s[0]=[i(`<h3 id="_240910-问题-docker下的doccano添加普通用户" tabindex="-1">240910-问题 Docker下的doccano添加普通用户 <a class="header-anchor" href="#_240910-问题-docker下的doccano添加普通用户" aria-label="Permalink to &quot;240910-问题 Docker下的doccano添加普通用户&quot;">​</a></h3><div class="tip custom-block"><p class="custom-block-title">整体实现方式</p><p>通过不断排查发现，24年最新版本的有一些bug，无法创建普通用户，只能创建超管然后将别的超管作为员工添加到项目中。</p></div><h4 id="_1-操作步骤" tabindex="-1">1. 操作步骤 <a class="header-anchor" href="#_1-操作步骤" aria-label="Permalink to &quot;1. 操作步骤&quot;">​</a></h4><h4 id="_1-1-启动docker的doccano" tabindex="-1">1.1 启动docker的doccano <a class="header-anchor" href="#_1-1-启动docker的doccano" aria-label="Permalink to &quot;1.1 启动docker的doccano&quot;">​</a></h4><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 需要提前创建好doccano服务才行（docker run …………）</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> restart</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> doccano</span></span></code></pre></div><h4 id="_1-2-进入doccano容器" tabindex="-1">1.2 进入Doccano容器 <a class="header-anchor" href="#_1-2-进入doccano容器" aria-label="Permalink to &quot;1.2 进入Doccano容器&quot;">​</a></h4><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> exec</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -it</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> doccano</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> bash</span></span></code></pre></div><h4 id="_1-3-配置-添加-超级管理员或者普通管理员账号" tabindex="-1">1.3 配置（添加）超级管理员或者普通管理员账号 <a class="header-anchor" href="#_1-3-配置-添加-超级管理员或者普通管理员账号" aria-label="Permalink to &quot;1.3 配置（添加）超级管理员或者普通管理员账号&quot;">​</a></h4><blockquote><p>因为doccano后端是采用Django框架搭建的，可以直接使用 manage.py 进行创建账户</p></blockquote><h5 id="_1-3-1-管理员账户" tabindex="-1">1.3.1 <strong>管理员账户</strong> <a class="header-anchor" href="#_1-3-1-管理员账户" aria-label="Permalink to &quot;1.3.1 **管理员账户**&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># python manage.py createuser --username &lt;用户名&gt; --email &lt;邮箱&gt; --password &lt;密码&gt;</span></span>
<span class="line"><span>python manage.py createuser --username demo  --password wazg123456</span></span></code></pre></div><p>这里我用我的远程win系统给大家演示</p><img src="https://coderethan-1327000741.cos.ap-chengdu.myqcloud.com/blog-pics/image-20241010220222677.png" alt="image-20241010220222677" style="zoom:67%;"><p>远程机访问测试管理员账户</p><img src="https://coderethan-1327000741.cos.ap-chengdu.myqcloud.com/blog-pics/image-20241010220329631.png" alt="image-20241010220329631" style="zoom:50%;"><p>登录成功：</p><img src="https://coderethan-1327000741.cos.ap-chengdu.myqcloud.com/blog-pics/image-20241010220352067.png" alt="image-20241010220352067" style="zoom:50%;"><h5 id="_1-3-2-普通用户账户" tabindex="-1">1.3.2 <strong>普通用户账户</strong> <a class="header-anchor" href="#_1-3-2-普通用户账户" aria-label="Permalink to &quot;1.3.2 **普通用户账户**&quot;">​</a></h5><p>我使用createuser 发现没了，然后查看manage.py help</p><p><img src="https://coderethan-1327000741.cos.ap-chengdu.myqcloud.com/blog-pics/image-20241010224949885.png" alt="image-20241010224949885"></p><p>结果发现只有这些api</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">Available</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> subcommands:</span></span>
